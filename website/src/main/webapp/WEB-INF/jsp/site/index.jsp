				...
				<div class="col-xs-12 col-sm-6 col-lg-4">
					<a href="${pageContext.request.contextPath}/${institution.slug}" class="panel panel-default institution-panel">
						<span class="panel-body">
							...
							<span class="panel-subtitle"><strong class="helper-count">${institution.attributes['$$helpers']}</strong><strong class="donations-count">$${institution.attributes['$$donations']}</strong></span>
						</span>
					</a>
				</div>
			</c:forEach>
